...
public:
    ...
    QspTextBox *GetVars() const
    {
        return _descTextBox;
    }
#else
    QspWebBox *GetDesc() const
    {
        return _mainDescTextBox;
    }
    QspWebBox *GetVars() const
    {
        return _descTextBox;
    }
#endif
    QspInputBox *GetInput() const
    {
        return _inputTextBox;
    }
    QspListBox *GetActions() const
    {
        return _actionsListBox;
    }
    QspListBox *GetObjects() const
    {
        return _objectsListBox;
    }
    ...
    {
        return _objectsWidget;
    }
    QDockWidget *GetImageDock() const
    {
        return _imgViewWidget;
    }
    ...
    {
        return m_isShowHotkeys;
    }
    bool IsQuit() const
    {
        return m_isQuit;
    }
    bool IsKeyPressedWhileDisabled() const
    {
        return m_keyPressedWhileDisabled;
    }
    ...
    void SetLinkColor(const QColor &new_color)
    {
        m_settingsLinkColor = new_color;
        if (m_isUseLinkColor) ApplyLinkColor(new_color);
    }
    void SetBackgroundColor(const QColor &new_color)
    {
        m_settingsBackColor = new_color;
        if (m_isUseBackColor) ApplyBackColor(new_color);
    }
    void SetForegroundColor(const QColor &new_color)
    {
        m_settingsFontColor = new_color;
        if (m_isUseFontColor) ApplyFontColor(new_color);
    }
    ...
    bool GetUseFontSize()
    {
        return m_isUseFontSize;
    }
    void SetUseFontSize(bool isUseFontS)
    {
        m_isUseFontSize = isUseFontS;
    }
    int GetFontSize()
    {
        return m_fontSize;
    ...
    void SetUseFont(bool isUseFont)
    {
    ...
    void SetFont(const QFont &new_font)
    {
        m_font = new_font;
        if (m_isUseFont) ApplyFont(new_font, 2, 2);
    }
    bool GetAutostart()
    {
        return autostartLastGame;
    }
    void SetAutostart(bool isAutostart)
    {
        autostartLastGame = isAutostart;
    }
    bool GetPerGameConfig()
    {
        return perGameConfig;
    }
    void SetPerGameConfig(bool isPerGameConfig)
    {
        perGameConfig = isPerGameConfig;
    }
    bool GetUseBackColor()
    {
        return m_isUseBackColor;
    }
    void SetUseBackColor(bool isUseBackColor)
    {
        m_isUseBackColor = isUseBackColor;
    }
    bool GetUseLinkColor()
    {
        return m_isUseLinkColor;
    }
    void SetUseLinkColor(bool isUseLinkColor)
    {
        m_isUseLinkColor = isUseLinkColor;
    }
    bool GetUseFontColor()
    {
        return m_isUseFontColor;
    }
    void SetUseFontColor(bool isUseFontColor)
    {
        m_isUseFontColor = isUseFontColor;
    }
    QString GetLangID()
    {
        return langid;
    }
    void SetLangID(const QString &new_langid)
    {
        langid = new_langid;
    }
    ...
    bool GetAllowHTML5Extras()
    {
        return m_isAllowHTML5Extras;
    }
